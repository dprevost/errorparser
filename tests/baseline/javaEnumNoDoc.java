...
public enum javaEnumNoDoc {
    ...
    private static final HashMap<Integer,javaEnumNoDoc> reverseLookup = new HashMap<Integer,javaEnumNoDoc>();

    static {
        for ( javaEnumNoDoc err : javaEnumNoDoc.values() ) {
            reverseLookup.put( err.getErrorNumber(), err );
        }
    }

    public static javaEnumNoDoc getEnum(int errcode) {
