...
public enum javaEnumDoc {
    ...
    private static final HashMap<Integer,javaEnumDoc> reverseLookup = new HashMap<Integer,javaEnumDoc>();

    static {
        for ( javaEnumDoc err : javaEnumDoc.values() ) {
            reverseLookup.put( err.getErrorNumber(), err );
        }
    }

    public static javaEnumDoc getEnum(int errcode) {
